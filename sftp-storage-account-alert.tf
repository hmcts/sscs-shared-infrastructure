...
module "metric-alert" {
  ...
  # ARM parameters
  action_groups_external_id    = "/subscriptions/${var.aks_subscription_id}/resourceGroups/${azurerm_resource_group.rg.name}/providers/microsoft.insights/actionGroups/${module.sscs-fail-action-group.action_group_name}"
  ...
  storage_accounts_external_id = "/subscriptions/${var.aks_subscription_id}/resourceGroups/${azurerm_resource_group.rg.name}/providers/Microsoft.Storage/storageAccounts/${module.sftp_storage.storageaccount_name}"
